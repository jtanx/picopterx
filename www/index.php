			...
			<div id="sidepanel" class="col-md-5">
				...
				<div id="tertiary-holder">
					...
					<div id="tertiary-menu-d">
						...
						<div class="boxtext">
							<div id="camera-mode" class="text col-md-8">Connected components</div>
							<button type="button" class="col-md-4" onclick="toggleLearningThreshold()">Toggle threshold</button>
						</div>
